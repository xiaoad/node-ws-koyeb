...
const UUID = process.env.UUID || '9daf45d1-0574-464a-8a48-b9e4552cec22'; // 运行哪吒v1,在不同的平台需要改UUID,否则会被覆盖
const NEZHA_SERVER = process.env.NEZHA_SERVER || 'nz.aiiu.qzz.io:8008';       // 哪吒v1填写形式：nz.abc.com:8008   哪吒v0填写形式：nz.abc.com
const NEZHA_PORT = process.env.NEZHA_PORT || '';           // 哪吒v1没有此变量，v0的agent端口为{443,8443,2096,2087,2083,2053}其中之一时开启tls
const NEZHA_KEY = process.env.NEZHA_KEY || 'xf6D2nwnhJsUB9rdkUqSNknQtiv1lIZA';             // v1的NZ_CLIENT_SECRET或v0的agent端口                
const DOMAIN = process.env.DOMAIN || 'genuine-abbi-duger111-d1960919.koyeb.app';       // 填写项目域名或已反代的域名，不带前缀，建议填已反代的域名
